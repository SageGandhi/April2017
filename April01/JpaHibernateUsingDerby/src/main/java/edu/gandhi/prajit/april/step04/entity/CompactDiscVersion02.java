...
public class CompactDiscVersion02 extends Item {
	...
	private Set<Musician02> musicians = new HashSet<>();

	public CompactDiscVersion02() {
	}
	 ...
	 * @param title
	 */
	public CompactDiscVersion02(String title) {
		this.title = title;
	}
	 ...
	 * @param genre
	 */
	public CompactDiscVersion02(String title, String genre) {
		this.title = title;
		this.genre = genre;
	}
	 ...
	 * @param genre
	 */
	public CompactDiscVersion02(String title, String description, Float unitCost, Float totalDuration, String genre) {
		this.title = title;
	 ...
	 */
	public final Set<Musician02> getMusicians() {
		return musicians;
	}
	 ...
	 */
	public final void setMusicians(Set<Musician02> musicians) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CompactDiscVersion02)) {
			return false;
		}
		CompactDiscVersion02 other = (CompactDiscVersion02) obj;
		if (genre == null) {
			if (other.genre != null) {
				return false;
			}
