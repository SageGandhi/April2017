...
public class Musician00 {
	 ...
	 */
	public Musician00(String firstName, String lastName, String bio, Date dateOfBirth, Integer age,
	 ...
	 * @param lastName
	 */
	public Musician00(String firstName, String lastName) {
		this.firstName = firstName;
		this.lastName = lastName;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof Musician00)) {
			return false;
		}
		Musician00 other = (Musician00) obj;
		if (age == null) {
			if (other.age != null) {
				return false;
			}
