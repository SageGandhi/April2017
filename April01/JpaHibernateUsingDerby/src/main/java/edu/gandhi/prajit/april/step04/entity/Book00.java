...
@Entity
public class Book00 extends Item {
	@Column(length = 15)
	private String isbn;
	 ...
	 * @param isbn
	 */
	public Book00(String title, String isbn) {
		this.title = title;
		this.isbn = isbn;
	}
	 ...
	 */
	public Book00(String title, String description, Float unitCost, String isbn, Integer nbOfPage,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof Book00)) {
			return false;
		}
		Book00 other = (Book00) obj;
		if (isbn == null) {
			if (other.isbn != null) {
				return false;
			}
