...
public class HqlApplication04 {
	/**lower Function Used*/
	private static final String Query00="Select distinct transaction.account From Transaction transaction Where transaction.amount > 500 and lower(transaction.transactionType)='deposit'";
